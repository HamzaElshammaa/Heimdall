  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Conduct a retrieval test to check if Heimdall can recover the intended content for the LLM.',
      Parse: 'Parse',
      dataset: 'Knowledge base',
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      betaError:
        'Please acquire a Heimdall API key from the System Settings page first.',
      searching: 'Searching...',
      parsing: 'Parsing',
      uploading: 'Uploading',
    ...
    setting: {
      ...
      embeddingModel: 'Embedding model',
      embeddingModelTip:
        'The default embedding model for each newly created knowledge base. If you cannot find an embedding model from the dropdown, check if you are using Heimdall slim edition (which does not include embedding models) or check https://ragflow.io/docs/dev/supported_models to see if your model provider supports this model.',
